"""
A Random Forest Regressor agent that calls saved random forest model for pricing a product.
The product description is being vectorized and passed as a input (X variable) to the model.
"""
